        ...
        <x-jet-validation-errors class="mb-4" />
								<form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST" >
                                    ...
                                    <fieldset class="wrap-input">
										...
										<input type="text" id="frm-reg-email" name="phone_number" :value="phone_number" placeholder="phone number">
									</fieldset>
                                    <fieldset class="wrap-input">
										<label for="frm-reg-email">academic year</label>
                                        <select   name="year_type" :value="year_type" required>
                                            <option value="one"> First grade secondary</option>
                                            <option value="two">second grade secondary</option>
                                            <option value="three">Third year secondary</option>
                                        </select>
 									</fieldset>
									<fieldset class="wrap-title">
